...
export const videoAPI = {
  ...
  rotateVideo: (videoId, params) => client.post(`/edits/video/${videoId}/rotate`, params),
  adjustVolume: (videoId, params) => client.post(`/edits/video/${videoId}/volume`, params),
  muteVideo: (videoId) => client.post(`/edits/video/${videoId}/mute`),
  getVideoInfo: (videoId) => client.get(`/edits/video/${videoId}/info`),
